...
# 继承关系：TRANSICEnvOSC → TRANSICEnvOSCBase
# 主要功能：
# 包含家具部件的完整实现
# 支持家具装配任务
# 管理家具部件的状态和重置
...
# TRANSICEnvJPCBase - 关节位置控制基类
# 主要特点：
# 使用关节位置控制（Joint Position Control）
# 直接控制机器人关节角度
# 通过逆运动学计算关节目标位置
...
# 继承关系：TRANSICEnvJPC → TRANSICEnvJPCBase
# 主要功能：
# 包含家具部件的完整实现
# 支持家具装配任务
# 管理家具部件的状态和重置
